...
export const REGIONS: Region[] = [
	{
		...
		learningFocus:
			"同じピノ・ノワールでも、道1本を隔てた畑で味わいが変わる。区画の位置関係を" +
			"地図で追うと、ラベルの村名・畑名がそのまま味の予想につながる。",
	},
	{
		id: "beaujolais",
		nameJa: "ボジョレー",
		...
		learningFocus:
			"花崗岩の丘に並ぶ10のクリュは、北から南へ順に味わいの重心が移っていく。" +
			"位置を覚えると、同じガメイでも軽やかなものと重厚なものを産地名で見分けられる。",
	},
	{
		id: "piemonte",
		nameJa: "ピエモンテ",
		...
		learningFocus:
			"バローロは11の村それぞれで味わいが違う。ネッビオーロという1つの品種を、" +
			"村と斜面の向きから読み解いていく面白さがある。",
	},
	{
		id: "toscana",
		nameJa: "トスカーナ",
		...
		learningFocus:
			"同じサンジョヴェーゼが、キアンティ・モンタルチーノ・モンテプルチャーノで" +
			"別の名前と表情を持つ。産地を地図で並べると、名前の違いが味の違いとして腑に落ちる。",
	},
	{
		id: "bordeaux",
		nameJa: "ボルドー",
		...
		learningFocus:
			"味わいの単位が畑ではなくシャトー。左岸と右岸でブレンドの主役が入れ替わるため、" +
			"シャトーの位置を覚えるとラベルから中身を推測できるようになる。",
	},
	{
		id: "alsace",
		nameJa: "アルザス",
		...
		learningFocus:
			"ラベルに品種名が書かれる珍しい産地。51のグラン・クリュは土壌ごとに得意な品種が" +
			"異なり、畑と品種の組み合わせで味わいが決まる関係を追いかけられる。",
	},
	{
		id: "champagne",
		nameJa: "シャンパーニュ",
		...
		learningFocus:
			"畑ではなく村そのものに格付けがある産地。モンターニュのピノ・ノワール、" +
			"コート・デ・ブランのシャルドネと、村の位置がそのまま味の設計図になる。",
	},
	{
		id: "loire",
		nameJa: "ロワール",
		...
		learningFocus:
			"川を東へ遡るほど品種もスタイルも移り変わる。河口のミュスカデから上流の" +
			"サンセールまで位置関係を掴むと、バラバラに見える多様さが一本の線でつながる。",
	},
	{
		id: "rhone",
		nameJa: "ローヌ",
		...
		learningFocus:
			"北はシラー単一、南はグルナッシュ主体のブレンド。同じ川沿いにある対照的な" +
			"二つの世界を、南北の位置だけで覚えられる。",
	},
];
